	                    ...
	                    <div class="row no-gutters">
	                        <div class="col-lg-6">
	                            <div class="center p-5">
	                                <div class="mb-5">
	                                     <!--<h3 class="h4 font-weight-bold  text-center">Voting Closed</h3>-->
                                       <p>&nbsp;</p>
                                        <h6>To register your vote please input your mobile
                                            number on which you wish to receive the OTP.</h6>
                                        <h6>You can fill a form once using one mobile number.</h6>
	                                </div>
                                    @if ($errors->any())
	                                ...
	                                <form method="POST" action="{{ url('signup') }}">	                                  
                                        ...
                                        */ @endphp
                                        <div class="form-group">
	                                        <label for="exampleInputMobile">Mobile number (You will receive an OTP for verification)*</label>
	                                        <input name="mobile" type="number"   class="form-control" id="exampleInputMobile" required/>
	                                    </div>                 
	                                    <center><button type="submit" class="btn btn-danger center-block">SignUp</button></center>
	                                </form>
	                            </div>
	                        </div>
	                        <div class="col-lg-6 cc d-lg-inline-block">
                ...
                <div class="container">
                    <div class="row">
                        <div class="column two-third">
                            <p style="color:white;">Aparajita <br> Sanmarg Bhawan<br> 160B Chittaranjan Avenue,<br>2nd Floor, Kolkata - 700007</p>
