...
<body>
    ...
    <div class="container event-schedule-area-two p-2 mt-2"> 
            <div class="sandbox sandbox-correct-pronounciation" style="padding:10% 0 6% 0">
       ...
       <center> <a href="/userlogout"><button type="submit" class="btn btn-danger btn-lg" >Back to Home Page</button></a><center>
    <br><br>
    ...
    <div class="column one footer">
        ...
        <footer class="footerMain">
            <div class="footerMainmenu">
                <div class="container">
                    <div class="row">
                        <div class="column two-third text-left">
