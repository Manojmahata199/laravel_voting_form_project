...
<body>
    ...
    @csrf 
        ...
        <div class="container event-schedule-area-two p-2 mt-2"> 
            ...
            <div class="tab-content radius-15">
               <center> <h3 class="cat_type">{{$subcategory->display_name}}</h3></center>
            </div>        
            {{-- @php print_r($participants[$category->id][$subcategory->id]); @endphp --}}
            <div class="row row-cols-1 row-cols-lg-3 row-cols-xl-3  p-1 ">
                        ...
                        <div class="radius-15">
                            <div class="text-center">
                                <div class="radius-15"> 
                                    ...
                                    <img src="https://raghp.sanmarg.in/public{{ $url }}" width="auto" height="auto" class="responsive p-2 mx-auto d-block" alt="">
                                    <h5 class="mb-1 mt-3 cat_name">{{ $participant->name }}</h5>
                                    <p class="mb-1 dg">&nbsp;{{ $participant->position_english}}</p>
                                    
                                    <div>
                                        <button type="button" class="btn read-more" data-toggle="modal" data-target="#voterModalCenter"  
        ...
        <div class="row">
            <div class="sub-right">
                <label  id="clear_radio" class="bg-sweet">Clear All</label></div>  
            <div class="sub-left">
               <button type="submit" class="btn btn-danger btn-lg right-alg">Submit Vote</button></div>
        </div><br>
    ...
    <div class="modal fade" id="voterModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
