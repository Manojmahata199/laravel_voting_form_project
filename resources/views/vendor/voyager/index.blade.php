...
@section('content')
    <div class="page-content">
        ...
        <div  class="text-center bg-success h1"></div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;background-image:url('https://aparajitavoting.sanmarg.in/admin/voyager-assets?path=images%2Fwidget-backgrounds%2F01.jpg');">
                <div class="dimmer"></div>
                <div class="panel-content">
                    <i class="voyager-group"></i>        <h4>Total Votes : <span class="total_votes"></span></h4>
                    <p>You have  <span class="total_votes"></span> votes in your database. Click on button below to view all voting details.</p>
                    <a href="https://aparajitavoting.sanmarg.in/admin/user-votes" class="btn btn-primary">View all Voting Details</a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="panel-content">
                <a href="https://aparajitavoting.sanmarg.in/all-voting-csv-data" class="btn btn-primary mx-3">Export All Voting Data</a>
                
                <a href="https://aparajitavoting.sanmarg.in/all-voting-count-csv-data" class="btn btn-primary mx-3">Export All Vote Count List</a>
                
                <!--<a href="https://aparajita.sanmarg.in/admin/users" class="btn btn-primary mx-3">View Voter List</a>-->
            </div>
        </div>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function(){
            $.ajax({url: "https://aparajitavoting.sanmarg.in/total-votes", success: function(result){
                    $(".total_votes").html(result);
            }});
        });
    </script>
